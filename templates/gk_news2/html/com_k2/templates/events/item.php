          		...
          		<?php echo $this->item->event->K2BeforeDisplayContent; ?>
                    ...
                    <div class="itemAuthorData">
                              ...
                              <div class="itemAuthorBlock">
                                        ...
                                        <div class="gkAvatar"> <img src="<?php echo $this->item->author->avatar; ?>" alt="<?php echo K2HelperUtilities::cleanHtml(SpoudazoLibrary::getCustomAuthorName($this->item->author)); ?>" /> </div>
                                        <?php endif; ?>
                                        <div class="itemAuthorDetails">
                                                  <h3> <a rel="author" href="<?php echo $this->item->author->link; ?>"><?php echo SpoudazoLibrary::getCustomAuthorName($this->item->author); ?></a> </h3>
