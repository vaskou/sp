...
<section id="k2Container" class="itemListView userView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
		...
		<div class="itemAuthorData">
				<div class="itemAuthorBlock">
						...
						<div class="gkAvatar"> <img src="<?php echo $this->user->avatar; ?>" alt="<?php echo htmlspecialchars($this->user->name, ENT_QUOTES, 'UTF-8'); ?>" style="width:<?php echo $this->params->get('userImageWidth'); ?>px; height:auto;" />
						</div>
						<?php endif; ?>
					...
					<div class="itemsContainerWrap">
						...
						<div class="itemBlock">
							...
							<ul>
									...
									<li><time datetime="<?php echo JHtml::_('date', $item->created, JText::_(DATE_W3C)); ?>"><?php echo JHTML::_('date', $item->created, 'F j, Y'); ?></time></li>
									<?php endif; ?>
