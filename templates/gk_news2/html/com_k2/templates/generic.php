		...
		<div class="itemList">
				...
				<article>							
					...
					<div class="itemBlock">
						...
						<div class="itemBody<?php if(!$this->params->get('genericItemDateCreated')): ?> nodate<?php endif; ?>">
						...
						<ul>
							...
							<li><time datetime="<?php echo JHtml::_('date', $item->created, JText::_(DATE_W3C)); ?>"><?php echo JHTML::_('date', $item->created, JText::_('F j, Y')); ?></time></li>
							<?php endif; ?>
