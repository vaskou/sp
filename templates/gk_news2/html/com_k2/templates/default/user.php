...
<section id="k2Container" class="itemListView userView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
    ...
    <div class="itemAuthorData">
        <div class="itemAuthorBlock">
            ...
            <div class="gkAvatar"> <img src="<?php echo $this->user->avatar; ?>" alt="<?php echo htmlspecialchars($this->user->name, ENT_QUOTES, 'UTF-8'); ?>" style="width:<?php echo $this->params->get('userImageWidth'); ?>px; height:auto;" /> </div>
            <?php endif; ?>
                        ...
                        <article class="itemView sp-news-item <?php if(!$item->published || ($item->publish_up != $this->nullDate && $item->publish_up > $this->now) || ($item->publish_down != $this->nullDate && $item->publish_down < $this->now)) echo ' itemViewUnpublished'; ?><?php echo ($item->featured) ? ' itemIsFeatured' : ''; ?> clearfix"> <?php echo $item->event->BeforeDisplay; ?> <?php echo $item->event->K2BeforeDisplay; ?>
                            <div class="itemBlock">
                                ...
                                <div class="sp-news-item-content">
                                    ...
                                    <div class="itemBody<?php if(!$this->params->get('userItemDateCreated')): ?> nodate<?php endif; ?>"> <?php echo $item->event->BeforeDisplayContent; ?> <?php echo $item->event->K2BeforeDisplayContent; ?>
                                        ...
                                        <?php endif; ?>
                                        <?php echo $item->event->AfterDisplayContent; ?> <?php echo $item->event->K2AfterDisplayContent; ?> </div>
                                ...
                                <div class="sp-news-item-info">
                                    ...
                                    <ul>
                                        ...
                                        <li> <i class="fa fa-comments"></i>
                                            ...
                                            <?php else: ?>
                                            <a href="<?php echo $item->link; ?>#itemCommentsAnchor"> <?php echo $item->numOfComments; ?></a>
                                            <?php endif; ?>
                                        </li>
                                        <?php endif; ?>
                                        <?php if(isset($item->editLink)): ?>
                                        <!-- Item edit link -->
                                        <li class="userItemEditLink"> <a class="modal" rel="{handler:'iframe',size:{x:990,y:550}}" href="<?php echo $item->editLink; ?>"> <?php echo JText::_('K2_EDIT_ITEM'); ?> </a> </li>
                                        <?php endif; ?>
                                    </ul>
                                    <?php endif; ?>
