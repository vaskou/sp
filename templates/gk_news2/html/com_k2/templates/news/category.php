...
<div id="k2Container" class="itemListView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
		...
		<div class="itemList">
				...
				<div id="itemListPrimary">
						...
						<?php if(($key+1)%($this->params->get('num_primary_columns'))==1 || $this->params->get('num_primary_columns') == 1): ?>
						<div class="itemListRow gkListCols<?php echo $this->params->get('num_primary_columns'); ?>">
						<?php endif; ?>
				...
				<div id="itemListSecondary">
						...
						<?php if(($key+1)%($this->params->get('num_secondary_columns'))==1 || $this->params->get('num_secondary_columns') == 1): ?>
						<div class="itemListRow gkListCols<?php echo $this->params->get('num_secondary_columns'); ?>">
						<?php endif; ?>
